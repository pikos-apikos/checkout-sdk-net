...
//            CardTokenResponse cardTokenResponse = await _api.Tokens.RequestAsync(cardTokenRequest);
            
//            PaymentRequest<TokenSource> paymentRequest = new ;
...
//        {
//            PaymentRequest<TokenSource> paymentRequest = TestHelper.CreateCardPaymentRequest();
...
//            paymentDetails.Source.AsTokenSource().ShouldNotBeNull();
//        }
